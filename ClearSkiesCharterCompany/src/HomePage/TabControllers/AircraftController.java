...
public class AircraftController implements Initializable {
    ...
    @FXML private TextField dailyrate;
    ...
    @FXML private TableColumn<AircraftData, String> aircraftRateColumn;
    ...
    private void initializeColumns(){
        ...
        aircraftRateColumn.setCellFactory(TextFieldTableCell.forTableColumn());
    ...
    private void loadAircraftData(ActionEvent event)throws SQLException{
        try{
            ...
            while (rs.next()){
                this.data.add(new AircraftData(rs.getString(1), rs.getString(2), rs.getString(3),
        ...
        this.aircraftRateColumn.setCellValueFactory(new PropertyValueFactory<AircraftData, String>("dailyrate"));
    ...
    private void addAircraft(ActionEvent event){
        String sqlInsert = "INSERT INTO Aircraft(ID, Type, Name, RequiresCopilot, NumberOfSeats, DailyRate) VALUES (?,?,?,?,?,?)";
        ...
        try {
            ...
            stmt.setString(6,this.dailyrate.getText());
    ...
    @FXML
    private void changeDailyRateCellEvent(TableColumn.CellEditEvent<AircraftData, String> editedCell){
        AircraftData aircraftSelected = aircrafttable.getSelectionModel().getSelectedItem();
        aircraftSelected.setNumberofseats(editedCell.getNewValue().toString());
        String sqlChangeNumberOfSeats = "UPDATE Aircraft SET DailyRate= ? WHERE ROWID = ?";
